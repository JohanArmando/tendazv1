...
(function() {
  ...
  /**
   * Controllers for the mdCalendar component.
  ...
  function CalendarCtrl($element, $scope, $$mdDateUtil, $mdUtil,
     ...
     * to the ng-model value if set, otherwise to today. It will be updated as the users navigates
     * to other months. The cell corresponding to the displayDate does not necesarily always have
     * focus in the document (such as for cases when the users is scrolling the calendar).
     * @type {Date}
     */
...
(function() {
  ...
  /**
   * Controllers for the calendar month component.
   * ngInject @constructor
   */
...
(function() {
  ...
  /**
   * Controllers for a single calendar month.
   * ngInject @constructor
   */
