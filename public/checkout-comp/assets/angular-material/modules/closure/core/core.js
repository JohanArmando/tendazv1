...
function MdGesture($$MdGestureHandler, $$rAF, $timeout) {
  ...
  return self
    ...
    /*
     * The drag handler dispatches a drag event if the users holds and moves his finger greater than
     * <minDistance> px in the x or y direction, depending on options.horizontal.
     * The drag will be cancelled if the users moves his finger greater than <minDistance>*<cancelMultiplier> in
     * the perpendicular direction. Eg if the drag is horizontal and the users moves his finger <minDistance>*<cancelMultiplier>
...
/**
 * Controllers used by the ripple service in order to apply ripples
 * ngInject
 */
