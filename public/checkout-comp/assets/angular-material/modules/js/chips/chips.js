...
/**
 * Controllers for the MdChip component. Responsible for handling keyboard
...
/**
 * Controllers for the MdChips component. Responsible for adding to and
...
/**
 * Configures the required interactions with the ngModel Controllers.
...
MdChipsCtrl.prototype.hasFocus = function () {
  ...
  function MdChips ($mdTheming, $mdUtil, $compile, $log, $timeout, $$mdSvgRegistry) {
     ...
     *
     * If no users-passed `md-chip-template` exists, the default template is used. This resulting
     ...
     * If no users input is provided, a default one is appended to the input container node in the
     * template.
     *
     ...
     */
    function compile(element, attr) {
      // Grab the users template from attr and reset the attribute to null.
...
/**
 * Controllers for the MdContactChips component
 * @constructor
 */
