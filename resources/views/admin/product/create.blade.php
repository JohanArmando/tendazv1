                            ...
                            <div class="col-md-12">
                                ...
                                <div class="tab-content panel" style="padding: 2.5%">
                                    ...
                                    <div class="tab-pane np" id="comments">
                                        <div class="media-list">
<<<<<<< HEAD
                                            {!! Form::open(['url' => url ("admin/products"."?client_secret=".$shop->uuid."&client_id=".$shop->id)
                                             , 'method' => 'POST' , 'class' => 'dropzone hidden-xs hidden-sm' ,'id' => 'my-dropzone-avanzado' ,
                                             'files' => true,'role'=>'form', 'data-toggle'=> 'validator']) !!}
