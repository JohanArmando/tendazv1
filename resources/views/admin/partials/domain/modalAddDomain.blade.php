                ...
                <div class="row">
                    <div class="col-sm-12">
                        <form name="form-check-domain">
                           <input type="hidden" name="url-check-domain" value="{{ url('admin/configuration/domain/check') }}">
                           ...
                           <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" style="width: 290px;">
                        ...
                        <div class="text-right">
                            ...
                            <button type="submit" class="btn btn-primary" style="border-radius: 0 !important;"> <i class="fa fa-check"></i></button>
                        </div>
                    </form>
