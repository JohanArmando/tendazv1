    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form" action="{{ url('admin/configuration/domain') }}" data-token="{{ csrf_token() }}" name="add_domain" >
                    ...
                    <button type="button" class="btn btn-default" data-dismiss="modal" style="background: #3C3C3C; border-radius: 0px !important;"><i class="fa fa-times" style="color: white;"></i></button>
                        <button type="button" class="btn btn-primary" id="add-domain" style="border-radius: 0px !important"><i style="color: white;" class="fa fa-check"></i></button>
                    </div>
                </form>
                <br>
            </div>
