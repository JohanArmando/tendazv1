                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 col-xs-12">
                                ...
                                <table class="shop_table cart" ng-show="size(carts) >= 1" style="width: 100%">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <tr class="cart-item"  ng-repeat="cart in carts" ng-cloak="">
                                            <td class="product-thumbnail">
                                                <a href="#">
                                                    <img ng-src="<% cart.attributes.image %>" alt="" width="100" height="100"/>
                                                </a>
                                                <a href="#"><% cart.name %></a>
                                            </td>
                                            ...
                                            <td class="product-remove">
                                                <a  ng-click="destroy(cart.id)" class="remove"><i class="fa fa-trash-o"></i></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" class="actions">
                                                <a class="continue hidden-xs" href="{{url('/products')}}">Continuar comprando</a>
                                                <a class="continue hidden-xs" style="margin-left: 10px" ng-click="emptyCart()">
                                                    <i class="fa fa-trash-o"></i> Limpiar Carrito
                                                </a>
                                                <a href="{{url('checkout/address_and_login/'.$shop->id)}}" type="submit" class="button"
                                                   name="update_cart">Proceder a Pago</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                <table class="shop_table cart" ng-show="size(carts) < 1">
                        ...
                        <div class="cart-collaterals" ng-show="size(carts) >= 1">
