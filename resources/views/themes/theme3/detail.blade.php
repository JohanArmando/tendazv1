            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product">
                        <div class="single-inner">
                            <div class="images">
                                <div class="product-simple-image">
                                    <img ng-src="<%  BASEURL + '/uploads-products/'  + store + '/' + detail.images[0].path%>"
                                         id="matrix" alt="" height="400" width="350px" class="image-responsive" />
                                </div>
                            </div>
                        <div class="summary entry-summary">
                            <hr>
                            <h1 class="product_title entry-title"><% detail.product.name%></h1>
                            <div ng-if="detail.product.price_promotion > 0">
                                <strong class="price">$ <% detail.product.price_promotion_amount | number:0%></strong>&nbsp;&nbsp;&nbsp;
                                <strong class="price" style="text-decoration: line-through; color: red;">$ <% detail.product.price | number:0 %></strong>
                            </div>
                            <div ng-if="!detail.product.price_promotion">
                                <strong class="price">$ <% detail.product.price | number:0%></strong>&nbsp;&nbsp;&nbsp;
                            </div>
                            <br><br>
                            <div class="product_meta">
                                <span class="col-xs-6">SKU:</span>
                                <span class="col-xs-6">
                                    <a href="#"><% detail.product.sku ? detail.product.sku : 'NONE' %></a><hr>
                                </span>
                                <span class="col-xs-6">Disponible:</span>
                                <span class="col-xs-6">
                                    <a href="#"><% detail.product.stock ? 'En Stock' : 'Sin Stock' %></a><hr>
                                </span>
                            ...
                            <form class="cart" ng-controller="productIndexController" ng-cloak="">
                                ...
                                <button ng-click="add(rand)" type="submit" class="single_add_to_cart_button button" >
                        ...
                        <div class="commerce-tabs" ng-if="detail.product.description">
                        ...
                        @include(Theme::get().'.partials.related-product')
                        </div>
                    </div>
                </div>
