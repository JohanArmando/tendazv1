<div id="modal_Add_dir" class="modal fade" tabindex="-1" role="dialog" aira-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Nuva Direccion</h4>
			</div>
					...
					<div class="row">
						<div class="col-xs-2">
							<div class="form-group">
								<label>ID</label>
								<input type="text" name="" class="form-control" value="001" disabled>
							</div>
						</div>
						<div class="col-xs-5">
							<div class="form-group">
