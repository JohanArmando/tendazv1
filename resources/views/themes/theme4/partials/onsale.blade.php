<div class="col-sm-12 col-md-6 col-xl-6 col-xs-12">
	...
	<slick ng-if="promotions" class="carousel-products row" current-index="index" responsive="breakpoints" slides-to-show=3 slides-to-scroll=1  prev-arrow=".btn-prev" next-arrow=".btn-next">
