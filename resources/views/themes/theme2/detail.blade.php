            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-5">
                        <div class="box">
                            <div>
                                <img  id="matrix" ng-src="<%  BASEURL + '/uploads-products/'  + store + '/' + detail.images[0].path%>"
                                     alt="" style="max-height:550px" class="img-responsive" />
                            </div>
                        </div>
                        <div class="box col-xs-12" style="display: inline-block">
                            <div class="col-xs-4" ng-repeat="image in detail.images | limitTo:3"
                                 ng-if="detail.images.length > 0" style="margin-top: 10px">
                                <a href="#" class="image-click thumb active">
                                    <img ng-src="<% BASEURL + '/uploads-products/'  + store + '/' + image.path %>" alt="" class="img-responsive">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-7">
                        <div class="box">
                            <h1 class="text-center" style="color: #3DA892"><% detail.product.name%></h1>
                            <hr>
                            <div class="text-center" ng-if="detail.product.price_promotion > 0">
                                <strong style="font-size: 25px" class="price">$ <% detail.product.price_promotion_amount | number:0%></strong>&nbsp;&nbsp;&nbsp;
                                <strong class="price" style="font-size: 25px;text-decoration: line-through; color: red">$ <% detail.product.price | number:0 %></strong>
                            </div>
                            <div class="text-center" ng-if="!detail.product.price_promotion">
                                <strong style="font-size: 25px" class="price">$ <% detail.product.price | number:0%></strong>&nbsp;&nbsp;&nbsp;
                            </div>
                            <hr>
                            <br><br>
                            <div class="the-list">
                                ...
                                <div class="col-xs-6 text-center">
                                    <span class="green"><% detail.product.sku ? detail.product.sku : 'NONE' %></span><hr>
                                </div>
                                <div class="col-xs-6 text-center"><strong>Disponible</strong></div>
                                <div class="col-xs-6 text-center">
                                    <span class="green"><% detail.product.stock ? 'En Stock' : 'Sin Stock' %></span><hr>
                                </div>
                                <div class="col-xs-6 text-center"><strong>Medios de Pago</strong></div>
                                <div class="col-xs-6 text-center">
                                                    <span class="green">
                                                        <img src="{{asset('imagesMediosdePago/payment-1.png')}}" alt="">
                                                        <img src="{{asset('imagesMediosdePago/payment-2.png')}}" alt="">
                                                        <img src="{{asset('imagesMediosdePago/payment-3.png')}}" alt="">
                                                        <img src="{{asset('imagesMediosdePago/payment-4.png')}}" alt="">
                                                    </span><hr>
                                </div>
                            ...
                            <p class="text-center buttons" ng-controller="productIndexController" ng-cloak="">
                                ...
                                <a href="#" ng-click="add(rand)" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> Agregar al carrito</a>
                            </p>
                            </div>
                ...
                <div class="box" id="details" ng-if="detail.product.description">
                    <p>
                    <h4>Descripcion del Producto</h4>
                    <p ng-bind-html="detail.product.description | limitTo:250"></p>
                    <hr>
                    <div class="social">
                        <h4>Sigenos en</h4>
                        <p>
